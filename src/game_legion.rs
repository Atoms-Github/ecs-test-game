...
use crate::rts::{Position, TimedLife, Velocity, STARTING_VELOCITY, WORLD_SIZE, Spawner, Team, ColorComp, UniverseComp, Comp1, Comp2, Comp3};
...
impl GameLegion {
    pub fn new() -> GameLegion {
        ...
        GameLegion { world, schedule: schedule.build() }
    }
